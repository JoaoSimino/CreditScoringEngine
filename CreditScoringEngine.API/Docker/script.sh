...
#docker run -e "ConnectionStrings__DefaultConnection=Server=host.docker.internal,1433;Database=CreditScoringEngine;User Id=sa;Password=MyStr0ng!Passw0rd;TrustServerCertificate=True;" -p 8080:80 minimalapikickoff
